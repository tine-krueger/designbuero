...
const BusinessGraphics: NextPageWithLayout & NextPage<IBusinessGraphicsProps> = ({ data }) => {
	...
	return (
		<>
			...
			<main>
				{<Hero className={styles.hero} layout={'layout-3'} image={<CustomImage src={bgImage} alt={'Hero Background Pattern'} objectFit={'contain'} priority objectPosition={'top'} sizes={'(min-width: 1600px) 1600px, 100vw'} />} headline={{ text: 'Business Graphics', textColor: NGColor.grey }} />}
