	...
	return (
		<header className={classNames(classes)} {...attributes}>
			<div className={classNames(styles['inner-wrapper'], 'grid grid--justify-items-center')}>
				{!isBreakpoint && (
					<Link className={classNames(styles['home-link'], 'no-link visible-m')} href={'/'}>
						<CustomImage className={styles.logo} alt={'Logo Desingbüro'} src={'/assets/svg/Logo_desingbuero.svg'} />
					</Link>
				)}

				<div className={styles['nav-wrapper']}>
					<Link className={classNames(styles['home-link--small'], 'no-link')} href={'/'}>
						<CustomImage className={styles.logo} alt={'Logo Desingbüro'} src={'/assets/svg/Logo_desingbuero.svg'} />
					</Link>
					{isBreakpoint ? (
